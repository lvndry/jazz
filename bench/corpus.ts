...
/**
 * One conversation log, in the on-disk JSONL shape: a `conversation` header
 * followed by `message` events. Shared by the resume and search suites, which
 * read the same files in the app.
 */
