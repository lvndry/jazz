...
| **[Chat platforms](./chat-platforms.md)** — Telegram bridge | `docker compose up` | No (policy-gated) | ✅ Reference bridge |
| **[Chat platforms](./chat-platforms.md)** — Slack, Google Chat, Discord, your own app | your webhook → `jazz run` | No (policy-gated) | 🔧 Bring your own bridge |

> **On "bring your own bridge":** no Slack/Discord/Google Chat adapter ships in this repo
> today. What ships is the contract they'd all use, and a complete, deployed
> implementation of it for Telegram that you copy and re-point at a different transport.
> The transport-specific part is roughly 100 lines. See
...
flowchart LR
    subgraph front["Front doors"]
        ...
        CRON["launchd / cron"]
        CI["GitHub Actions"]
        BRIDGE["Chat bridge<br/>Telegram · Slack · Discord"]
    end
...
- **Agent definitions** — `~/.jazz/agents/*.json`. The Telegram bridge, your CI job, and your terminal can all run the *same* agent, or different ones.
...
| [Chat platforms](./chat-platforms.md) | How to put an agent in Telegram, Slack, Discord, or your own app |
