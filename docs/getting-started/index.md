---
description: "Install Jazz, configure a model, create your first AI agent, and choose the next capability or deployment surface to add."
---

# Getting started with Jazz

Use this path if you have not run Jazz before.
