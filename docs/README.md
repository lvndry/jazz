...
- **[Start](./start/index.md)** — install, create agents, run self-hosted or airgapped, end-to-end use cases
- **[Use cases](./use-cases/index.md)** — where Jazz runs: terminal, headless, chat, CI, scheduled
- **[Concepts](./concepts/index.md)** — agents, personas, skills, workflows, scheduling
- **[Playbooks](./playbooks/index.md)** — copy-pasteable workflow recipes
