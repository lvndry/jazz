...
This is the contributor-facing counterpart to the [maintainer documentation](./index.md): where
...
[Agent loop](./run-lifecycle.md) and [Context management](./context-lifecycle.md).
