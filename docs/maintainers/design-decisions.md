...
📄 [`summarizer.ts:222`](../../packages/core/src/agent/context/summarizer.ts#L222) · [Context management](./context-lifecycle.md#3--compaction-summarize-dont-truncate)
...
📄 [`context-window-manager.ts:94`](../../packages/core/src/agent/context/context-window-manager.ts#L94) · [Context management](./context-lifecycle.md#2--trimming-turn-aware-never-mid-tool-call)
...
📄 [`token-counter.ts`](../../packages/core/src/agent/context/token-counter.ts) · [Context management](./context-lifecycle.md#1--counting-tokens)
...
📄 [`ai-sdk-service.ts`](../../packages/adapters/src/llm/ai-sdk-service.ts) · [Providers & models](./add-a-provider.md)
...
type errors are intimidating. That's precisely why [Code map](./architecture.md) leads with the
