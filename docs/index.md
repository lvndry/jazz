...
- **Provider choice without losing the harness:** use cloud providers, Ollama, llama.cpp, or vLLM while keeping Jazz's tools, context controls, workflows, and surfaces.
