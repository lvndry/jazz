...
This is Jazz's built-in caveman skill (adapted from the MIT caveman skill).
`/caveman` loads it. Jazz already offloads old tool results and caches the
conversation prefix — this skill shrinks what you *say*, not what you *read*.
