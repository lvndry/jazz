...
export const skillTools: Tool<SkillService>[] = [
    {
        ...
        parameters: z.object({
            skill_name: z.string().describe("The exact name of the skill to load, as shown in the available skills list (e.g., 'commit-message', 'email', 'calendar', 'deep-research')")
        }),
        hidden: false,
        riskLevel: "read-only",
