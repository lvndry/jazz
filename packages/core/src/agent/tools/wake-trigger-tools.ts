...
export function createRegisterTriggerTool(): Tool<WakeTriggerToolDeps> {
  return defineTool<WakeTriggerToolDeps, RegisterTriggerArgs>({
    ...
    disclosure: "internal",
    summary:
      "Wake yourself up later to check back on anything that is not finished yet — monitor or " +
      "watch it over minutes, hours or days and keep looking until it resolves: a build, deploy " +
      "or CI run, a log file, a price or restock, a delivery, a reply, a long export, a site " +
      "coming back up.",
    keywords: [
      "monitor",
      "watch",
