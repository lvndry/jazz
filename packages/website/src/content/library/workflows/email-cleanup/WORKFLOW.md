...
3. **Automated notifications**: Archive GitHub notification emails, CI/CD notifications, and similar automated emails that I've already seen (they're in inbox but I've probably already addressed them via the platform directly).
...
- If you're unsure whether something is a newsletter or a personal message, skip it
- If the sender could be a real person (even if it looks promotional), skip it
