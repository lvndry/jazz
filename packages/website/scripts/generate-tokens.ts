...
import { GLYPHS } from "@jazz/cli/ui/glyphs";
import { MOTION, PALETTES, type ThemeColors } from "@jazz/cli/ui/theme";
...
const header = `/*
 * GENERATED from @jazz/cli's ui/theme.ts — do not edit by hand.
